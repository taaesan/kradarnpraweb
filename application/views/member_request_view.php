<div class="container" style="margin-top: 50px;">
	...
	<ul class="nav nav-pills">
		<li role="presentation" class="active">
			<a href="#" onclick="return false;">1. ข้อมูลสมาชิก</a>
		</li>
		<li role="presentation" class="disabled">
			<a href="#" onclick="return false;">2. อัพโหลดเอกสาร</a>
		</li>
	</ul>
	...
	<a id="showRule" href="#myModal1" role="button" class="btn" data-toggle="modal">กฎกติกากลุ่ม</a>
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="ตัวเลข 13 หลัก" maxlength="13" max="13" id="cid" name="cid" value="<?php echo set_value('cid', $cid); ?>" <?php
            if (strlen($id) > 0) { echo "disabled";
            }
 ?>
		/>
	</div>
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="หมายเลขบัญชีธนาคาร" id="accountNumber" name="accountNumber" maxlength="20" value="<?php echo set_value('accountNumber', $accountNumber); ?>"/>
	</div>

	<div class="form-group">
		<label for="phone">หมายเลขโทรศัพท์</label><?php echo form_error('phone'); ?>
		<input type="text" class="form-control" placeholder="เบอร์โทรติดต่อ" id="phone" name="phone" maxlength="20" value="<?php echo set_value('phone', $phone); ?>"/>
	</div>
...
?>
	...
	<button type="button" class="btn btn-lg btn-default" id="backButton">
		ยกเลิก
	</button>
